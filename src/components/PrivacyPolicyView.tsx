      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3 pb-4 border-b border-gray-150 dark:border-slate-800">
          <h1 className="text-2xl md:text-3xl font-extrabold text-slate-1000 dark:text-white flex items-center gap-2">
            ...
            {p.title || 'ضوابط، مقررات و حریم خصوصی اسپاب چی'}
          </h1>
        ...
        <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 p-6 md:p-8 rounded-3xl shadow-xs space-y-8 text-justify transition-colors duration-300">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-650 dark:text-slate-350 leading-relaxed text-justify">
              {p.intro || 'کاربر گرامی، ورود به وب‌سایت اسپاب چی و استفاده از خدمات مشاوره، محاسبه‌گر هوشمند آنلاین، و رزرو نوبت تلفنی یا اینترنتی به معنای آگاهی کامل و پذیرش بی قید و شرط قوانین درج شده در این صفحه می‌باشد. هدف ما آسودگی خاطر کامل شما در طول اسباب‌کشی و حفظ امانت به مطمئن‌ترین شکل ممکن است.'}
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4 text-xs md:text-sm font-medium text-gray-750 dark:text-slate-300">
              ...
              <div className="flex gap-2.5 items-start">
                <CheckCircle2 className="w-5 h-5 text-purple-600 dark:text-purple-400 shrink-0 mt-0.5" />
                <span className="leading-relaxed">
                  {p.rule_2 || 'لغو نوبت رزرو شده: مشتریان محترم در صورت نیاز به تغییر زمان اسباب‌کشی یا لغو نوبت، موظف هستند حداقل ۲۴ ساعت قبل از اعزام کادر جابجایی موضوع را به کارشناسان اسپاب چی اطلاع دهند.'}
                </span>
              </div>
              <div className="flex gap-2.5 items-start">
                <CheckCircle2 className="w-5 h-5 text-purple-600 dark:text-purple-400 shrink-0 mt-0.5" />
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-650 dark:text-slate-350 leading-relaxed text-justify">
              {p.privacy_text || 'مجموعه اسپاب چی نسبت به حفظ اطلاعات خصوصی مشتریان خود (مانند نام خانوادگی، شماره‌های همراه، آدرس‌های مبدا و مقصد) کاملاً متعهد است. تمامی اطلاعات وارد شده در وب‌سایت اسپاب چی در سرورهای امن نگهداری شده و فقط برای فرآیند اعزام خودرو، صدور بیمه نامه حمل بار و بهبود کیفیت خدمات مورد استفاده قرار می‌گیرند. ما هرگز داده‌های شما را در اختیار اشخاص ثالثِ تبلیغاتی قرار نخواهیم داد.'}
            </p>
          </div>
          ...
          <div className="bg-amber-50 dark:bg-amber-950/20 border border-amber-100 dark:border-amber-900/30 rounded-2xl p-4 flex gap-3 text-amber-900 dark:text-amber-200 text-xs leading-relaxed">
            ...
            <p className="text-justify font-bold">
              {p.box_alert || 'در صورت بروز هرگونه تعارض نامتعارف با پرسنل صحنه جابجایی قبل از هرگونه پرداخت وجه با شماره بازرسی مرکزی اسپاب چی تماس حاصل فرمایید تا کارشناس شعبه فوراً مداخله کند.'}
            </p>
          </div>
        </div>
      </div>
