...
export const DEFAULT_PACKING_DATA = {
  ...
  branches: [
    ...
    { name: 'شماره اسپاب چی مرکز تهران', phone: '02188634354', desc: 'ملاصدرا، یوسف‌آباد، مطهری، امیرآباد، گاندی، آرژانتین، شریعتی، جردن' },
    { name: 'شماره اسپاب چی غرب تهران', phone: '02126117092', desc: 'سعادت‌آباد، شهرک غرب، پونک، جنت‌آباد، مرزداران، شهران، گیشا، ستارخان' },
  ],
  pillarsTitle: "چیزی که ما را خاص می کند",
  pillarsSubtitle: "باربری و اتوبار اسپاب چی  باربری تهران",
  pillars: [
    {
      title: "کارکنان صمیمی",
  ...
  materials: [
    ...
    },
    {
      ...
      desc: "ما همواره سعید در ارائه بهتر خدمات را در حوزه باربری جهت رفاه مشتریان ارائه می دهیم.",
      image: "",
      badge: " خدمات"
    },
    {
  ...
  topics: [
    ...
    },
    {
      ...
      desc: "باربری و اتوبار اسپاب چی امکان رزرو اینترنتی اتوبار را فراهم آورده است. شما می‌توانید با تکمیل فرم آنلاین زمان اسباب کشی را انتخاب نمایید، کارشناسان با شما تماس خواهند گرفت. کافی است با شماره 09194880869 تماس حاصل فرمایید."
    },
    {
  ...
  concludingDesc: "مهمترین و اساسی ترین نکته برای ما برخورداری از کیفیت بالا در باربری و اتوبار اسپاب چی است و خوشبختانه توانستیم به عنوان بترین معرفی شویم. اثاث کشی خود را از صفر تا صد با خیالی آسوده به ما بسپارید."
};
...
export const DEFAULT_TRANSPORT_DATA = {
  ...
  heroDesc: "مخصوص حمل فوری اثاثیه سبک، بارهای تکی، مبلمان، یخچال و کارتن‌ها با وانت مجهز و نیسان‌های ضربه‌گیر دار پتو دار در هر ساعت از  و حتی ایام تعطیل با تعرفه منصفانه.",
  ...
  branches: [
    ...
    { name: 'شماره اسپاب چی مرکز تهران', phone: '02188634354', desc: 'ملاصدرا، ونک، یوسف آباد، مطهری، گاندی، آرژانتین' },
    { name: 'شماره اسپاب چی غرب تهران', phone: '02126117092', desc: 'پونک، مرزداران، صادقیه، پوتک، جنت‌آباد، شهران' },
  ],
  pillarsTitle: "چیزی که ما را خاص می کند",
  ...
  topics: [
    ...
    },
    {
      ...
      desc: "شما می‌توانید در تمامی ساعت  و ۷ روز هفته حتی تعطیلات رسمی با کارشناسان ما تماس گرفته و مشاوره رایگان دریافت کنید."
    },
    {
  ...
  concludingDesc: "حمل باری ایمن، پرسرعت و مقرون به صرفه را همین حالا تجربه کنید. پشتیبانی  اسپاب چی با شماره‌‌های مستقیم منتظر پاسخگویی به شما خوبان است."
};
...
export const DEFAULT_STORAGE_DATA = {
  ...
  branches: [
    ...
    { name: 'شعبه مرکز تهران', phone: '02188634354', desc: 'ملاصدرا، یوسف‌آباد، مطهری، امیرآباد' },
    { name: 'شعبه غرب تهران', phone: '02126117092', desc: 'سعادت‌آباد، شهرک غرب، پونک، ستارخان' },
  ],
  pillarsTitle: "امنیت ۱۰۰٪ بار در انبارهای اسپاب چی",
  pillarsSubtitle: "نگهبـان  فیزیکی، مجهز به پیشرفته‌ترین دوربین‌های مداربسته",
  pillars: [
    {
      title: "امنیت ",
  ...
  topics: [
    {
      ...
      desc: "اجاره انبار اسپاب چی ، اجاه انبار های مقف و روباز، خصوصی و عمومی در بهترین مکان در تهران با دوربین هی مداربسته ، نگهبان  روزی جهت نگهداری اثاثیه منزل،محل کار کالاهای تجاری و صنعتی آماده می باشد."
    },
    {
  ...
  videoUrl: "",
  concludingTitle: "اجاره انبار اسپاب چی با منصفانه قیمت",
...
export const DEFAULT_WORKERS_DATA = {
  ...
  branches: [
    ...
    { name: 'اعزام کارگر مرکز تهران', phone: '02188634354', desc: 'ملاصدرا، امیرآباد، سیدخندان، یوسف‌آباد، کریمخان' },
    { name: 'اعزام کارگر غرب تهران', phone: '02126117092', desc: 'سعادت‌آباد، شهرک غرب، پونک، جنت‌آباد، صادقیه، مرزداران' },
  ],
        ...
        <section className="space-y-6">
          <div className="text-center max-w-lg mx-auto space-y-2">
            <h2 className="text-xl md:text-2xl font-black text-slate-900">
              {slug === 'packing' ? 'شعبه‌های فعال بسته‌بندی اسپاب چی تهران' : (slug === 'storage' ? 'شعبه‌های فعال اجاره انبار اسپاب چی تهران' : (slug === 'transport' ? 'شعبه‌های فعال حمل اثاثیه منزل اسپاب چی تهران' : 'شعبه‌های فعال اعزام کارگر خالی اسپاب چی تهران'))}
            </h2>
        ...
        <section className="bg-gradient-to-r from-blue-700 to-indigo-800 text-white rounded-[40px] p-8 md:p-12 shadow-xl relative overflow-hidden">
          ...
          <div className="relative text-center max-w-xl mx-auto space-y-6">
            <h3 className="text-xl md:text-2xl font-black">
              {slug === 'packing' ? 'سفارش تلفنی بسته بندی اسپاب چی' : (slug === 'storage' ? 'سفارش تلفنی اجاره انبار اسپاب چی' : (slug === 'transport' ? 'سفارش تلفنی حمل اثاثیه منزل اسپاب چی' : 'سفارش تلفنی اعزام کارگر خالی اسپاب چی'))}
            </h3>
