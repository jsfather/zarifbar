...
export async function initDB() {
  ...
  if (settingsCount.count === 0) {
    const defaultSettings = [
      { key: 'site_title', value: 'اسپاب چی - اتوبار و حمل اثاثیه منزل مدرن و ظریف' },
      { key: 'site_description', value: 'اسپاب چی با کادری مجرب و ماشین‌آلات پیشرفته حمل اثاثیه منزل، کارگر خالی، بسته‌بندی حرفه‌ای و خدمات انبارداری در خدمت شماست.' },
      ...
      { key: 'seo_keywords', value: 'حمل اثاثیه, اثاث کشی, اسپاب چی, بسته بندی اثاث, وانت بار, کارگر خالی, اجاره انبار' },
    ...
    await dbInstance.run(`
      ...
      VALUES 
        ('packing', 
         ...
         'Package',
         'بهترین خدمات بسته‌بندی اثاثیه منزل در تهران | اسپاپ چی',
        ...
        ('workers', 
         ...
         'اگر خودرو تهیه کرده‌اید اما نیازمند نیروی توانمند هستید، نگران نباشید. نیروهای ورزیده، توانمند و کاملا خوش‌برخورد اسپاپ چی با بهترین تجهیزات حمل تخصصی گاوصندوق، سایدبای‌ساید، تردمیل، و پیانو، سخت‌ترین جابجایی‌ها را برای شما ساده می‌کنند. ما سلامتی اثاثیه گران‌بهای شما را تضمین می‌کنیم.',
         'https://images.unsplash.com/photo-1513151233558-d860c5398176?auto=format&fit=crop&q=80&w=800',
         'Users',
         'اعزام کارگر اثاث کشی مجرب و تنومند | اسپاپ چی',
        ...
        ('transport', 
         ...
         'با ناوگان بزرگ و مجهز مجهز به انواع پتو و ضربه‌گیر، جابجایی بارهای سبک‌تر مانند سرویس خواب، کمد، بوفه یا لوازم اداری به راحتی و با هزینه‌ای مناسب‌تر امکان‌پذیر شده است. رانندگان آشنا به مسیرهای سخت و شلوغ اسپاپ چی، امنیت بار شما را با بیمه نامه تضمین می‌کنند.',
         'https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?auto=format&fit=crop&q=80&w=800',
         'Truck',
         'حمل اثاثیه با وانت و نیسان بار پتو دار | اسپاپ چی',
        ...
        ('storage', 
         ...
         'Warehouse',
         'اجاره انبار موقت اثاثیه منزل و لوازم اداری | اسپاپ چی',
